...
<!-- Free Shipping Placeholders Info -->
<div class="wb-tool-card wb-tool-card-standalone">
    <div class="wb-tool-card-header">
        <div class="wb-tool-icon-row">
            ...
            <h3 class="wb-tool-title">{l s='Free Shipping Placeholders' mod='wiseblock'}</h3>
        </div>
        <p class="wb-tool-subtitle">{l s='Show customers how much they need for free shipping' mod='wiseblock'}</p>
    </div>
    <div class="wb-tool-card-body">
        <div class="wb-free-shipping-info" style="padding: 14px; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; margin-bottom: 16px;">
            <p style="margin: 0; font-size: 13px; color: #1e40af;">
                <strong>{l s='Threshold is read from:' mod='wiseblock'}</strong> {l s='Shipping Preferences' mod='wiseblock'} → {l s='Free shipping starts at' mod='wiseblock'}
            </p>
        </div>
        <div class="wb-free-shipping-info" style="padding: 14px; background: #f0fdf4; border: 1px solid #86efac; border-radius: 8px;">
            <p style="margin: 0 0 8px 0; font-weight: 600; color: #166534;">{l s='Available placeholders:' mod='wiseblock'}</p>
            <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #15803d;">
                <li><code>{literal}{{free_shipping_threshold}}{/literal}</code> - {l s='formatted threshold value' mod='wiseblock'}</li>
                <li><code>{literal}{{free_shipping_remaining}}{/literal}</code> - {l s='how much left to free shipping' mod='wiseblock'}</li>
                <li><code>{literal}{{free_shipping_progress}}{/literal}</code> - {l s='percentage progress (0-100)' mod='wiseblock'}</li>
                <li><code>{literal}{{#if_free_shipping_not_achieved}}...{{/if_free_shipping_not_achieved}}{/literal}</code> - {l s='show content only if not achieved' mod='wiseblock'}</li>
            </ul>
        </div>
    </div>
</div>
